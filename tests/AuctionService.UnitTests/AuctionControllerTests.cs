...
public class AuctionControllerTests
{
    ...
    public async Task GetAuctions_WithNoParams_Returns10Auctions()
    {
        ...
        _auctionRepo.Setup(repo => repo.GetAuctionAsync(null)).ReturnsAsync(auction);
    ...
    public async Task GetAuctionById_WithValidGuid_ReturnsAuction()
    {
        ...
        _auctionRepo.Setup(repo => repo.GetAuctionBuIdAsync(It.IsAny<Guid>())).ReturnsAsync(auction);
    ...
    [Fact]
    public async Task GetAuctionById_WithInvalidValidGuid_ReturnsNotFound()
    {
        // arange
        _auctionRepo.Setup(repo => repo.GetAuctionBuIdAsync(It.IsAny<Guid>()))
    ...
    [Fact]
    public async Task CreateAuction_WithInvalidCreateAuctionDto_ReturnsCreatedAction()
    {
        // arange
